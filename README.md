...
### LLM as Reasoner
![framework](assets/reasoner.PNG)

| **Year** | **Method**        | **Title**                                                                                                                  | **Paper**                                                                                                                | **Code**                                                               |
| -------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| 2024     | **TeC**           | **TeC: A Novel Method for Text Clustering with Large Language Models Guidance and Weakly-Supervised Contrastive Learning** | [link](https://ojs.aaai.org/index.php/ICWSM/article/view/31419)                                                          | -                                                                      |
| 2025     | **ZeroDL**        | **Zerodl: Zero-shot distribution learning for text clustering via large language models**                                  | [link](https://aclanthology.org/2025.findings-acl.1005.pdf)                                                              |                                                                        |
| 2024     | **LLMGNN**        | **Label-free node classification on graphs with large language models**                                                    | [link](https://openreview.net/pdf?id=hESD2NJFg8)                                                                         | [link](https://github.com/CurryTang/LLMGNN)                            |
| 2024     | **LLMEdgeRefine** | **LLMEdgeRefine: Enhancing text clustering with LLM-based boundary point refinement**                                      | [link](https://aclanthology.org/2024.emnlp-main.1025.pdf)                                                                | -                                                                      |
| 2024     | **GCLR**          | **Large language model guided graph clustering**                                                                           | [link](https://openreview.net/pdf?id=CLyhlb5DG5)                                                                         | -                                                                      |
| 2023     | **ClusterLLM**    | **ClusterLLM: Large Language Models as a Guide for Text Clustering**                                                       | [link](https://arxiv.org/pdf/2305.14871)                                                                                 | [link](https://github.com/zhang-yu-wei/ClusterLLM)                     |
| 2025     | **Cafellm**       | **Cafellm: Context-aware fine-grained semantic clustering using large language models**                                    | [link](https://arxiv.org/abs/2405.00988)                                                                                 | [link](https://github.com/amazon-science/context-aware-llm-clustering) |
| 2025     | **MARK**          | **MARK: Multi-agent collaboration with ranking guidance for text-attributed graph clustering**                             | [link](https://aclanthology.org/2025.findings-acl.314.pdf)                                                               | [link](https://github.com/fuyw-aisw/MARK)                              |
| 2025     | **Locle**         | **Leveraging Large Language Models for Effective Label-free Node Classification in Text-Attributed Graphs**                | [link](https://dl.acm.org/doi/10.1145/3726302.3730021)                                                                   | [link](https://github.com/HKBU-LAGAS/Locle)                            |
| 2025     | **ClusterFusion** | **ClusterFusion: Hybrid Clustering with Embedding Guidance and LLM Adaptation**                                            | [link](https://arxiv.org/pdf/2512.04350)                                                                                 | [link](https://github.com/YimingXu1213/clusterFusion)                  |
| 2024     | **IDC**           | **Interactive Deep Clustering via Value Mining**                                                                           | [link](https://proceedings.neurips.cc/paper_files/paper/2024/file/4ac4365b98bc242acd5ab974a05c68a8-Paper-Conference.pdf) | [link](https://github.com/XLearning-SCU/2024-NeurIPS-IDC)              |


### LLM as Optimizer
![framework](assets/optimizer.PNG)

| **Year** | **Method**    | **Title**                                                                                                           | **Paper**                                                | **Code**                                                               |
| -------- | ------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------------------- |
| 2025     | **KCluster**  | **KCluster: An LLM-based Clustering Approach to Knowledge Component Discovery**                                     | [link](https://arxiv.org/pdf/2505.06469)                 | [link](https://github.com/weiyumou/KCluster)                           |
| 2025     | **LLM-CER**   | I**n-context clustering-based entity resolution with large language models: A design space exploration**            | [link](https://arxiv.org/pdf/2506.02509)                 | -                                                                      |
| 2021     | **EnsLM**     | **EnsLM: Ensemble language model for data diversity by semantic clustering**                                        | [link](https://aclanthology.org/2021.acl-long.230.pdf)   | [link](https://github.com/BoChenGroup/EnsLM)                           |
| 2023     | **SIC**       | **Semantic-enhanced image clustering**                                                                              | [link](https://arxiv.org/pdf/2208.09849)                 | [link](https://github.com/Bruce-XJChen/SIC)                            |
| 2024     | **MCA**       | **Multi-level Cross-modal Alignment for Image Clustering**                                                          | [link](https://arxiv.org/pdf/2401.11740)                 | -                                                                      |
| 2024     | **GCLR**      | **Large language model guided graph clustering**                                                                    | [link](https://openreview.net/pdf?id=CLyhlb5DG5)         | -                                                                      |
| 2024     | **CACATUS**   | **Context-aware clustering using large language models**                                                            | [link](https://arxiv.org/pdf/2405.00988)                 | [link](https://github.com/amazon-science/context-aware-llm-clustering) |
| 2024     | **ICTC**      | **Image clustering conditioned on text criteria**                                                                   | [link](https://arxiv.org/pdf/2310.18297)                 | [link](https://github.com/sehyunkwon/ICTC)                             |
| 2025     | **Li et al.** | **Co-Evolving LLMs and Embedding Models via Density-Guided Preference Optimization for Text Clustering**            | [link](https://aclanthology.org/2025.emnlp-main.241.pdf) | -                                                                      |
| 2023     | **GPT4Graph** | **GPT4Graph: Can Large Language Models Understand Graph Structured Data? An Empirical Evaluation and Benchmarking** | [link](https://arxiv.org/pdf/2305.15066)                 |                                                                        |
| 2024     | **GraphEdit**     | ** Graphedit: Large language models for graph structure learning**                                                  | [link](https://arxiv.org/pdf/2402.15183 )                | [link](https://github.com/HKUDS/GraphEdit)                             |
| 2025         |  **Chen et al.**             | **Agent-Centric Personalized Multiple Clustering with Multi-Modal LLMs**                                                                                                                    |  [link](https://arxiv.org/pdf/2503.22241)                                                        | -                                                                       |
| 2025         |    **D2CS**           |   **D2CS-Documents Graph Clustering using LLM supervision**                                                                                                                  | [link](https://aclanthology.org/anthology-files/anthology-files/pdf/findings/2025.findings-emnlp.1283.pdf)                                                         |  [link](https://github.com/D2CS-sub/D2CS)                                                                      |
|  2025        |   **Cequel**            |  **Cequel: Cost-Effective Querying of Large Language Models for Text Clustering**                                                                                                                   | [link](https://dl.acm.org/doi/pdf/10.1145/3746252.3761074)                                                         |  [link](https://github.com/HKBU-LAGAS/Cequel)                                                                      |
| 2025         |   **k-LLMmeans**            |   **Summaries as Centroids for Interpretable and Scalable Text Clustering**                                                                                                                  | [link](https://arxiv.org/pdf/2502.09667)                                                         | [link](https://github.com/jairoadiazr/summaryCentroids)                                                                       |
| 2025         |   **LLM-MemCluster**            |   LLM-MemCluster: Empowering Large Language Models with Dynamic Memory for Text Clustering                                                                                                                  |  [link](https://arxiv.org/pdf/2511.15424)                                                        |-                                                                        |
| 2025     | **Zhao et al.**          | **Dynamic bundling with large language models for zeroshot inference on text-attributed graphs**                                                                                                               | [link](https://openreview.net/pdf/d615b950a359ab4cc2684209840bedfc61f6d59e.pdf)                                                         | [link](https://github.com/YushengZhao/bundle-neurips25)                                                                       |
